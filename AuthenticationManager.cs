...
namespace  excelapi.logic
{
    public class AuthenticationManager: IDisposable
    {
        ...
        private const string tokenEndpoint = "https://login.microsoftonline.com/72f988bf-86f1-41af-91ab-2d7cd011db47/oauth2/token";

        private const string defaultAADAppId = "13dcb471-9b9f-4adc-b447-55f676d0ea2f";
        ...
        private async Task<string> AcquireTokenAsync(Uri resourceUri, string username, string password)
        {
            ...
            using (var stringContent = new StringContent(body, Encoding.UTF8, "application/x-www-form-urlencoded"))
            {
                ...
                Console.WriteLine("tokenresul"+tokenResult);
